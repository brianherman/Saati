...
def answer_question(body):
    ...
    if 5 >= sync_ratio <= 11 or interactions < 10:
        instance.next_state()
    elif 5 >= sync_ratio <= 11 and interactions > 10:
	responce =+ 'Hey, you want to meetup sometime? My number is 1 778 403 5044":
    else:
...
if __name__ == "__main__":
    ...
    gr.Interface(answer_question, "textbox", output_text).launch(share=True)
