...
"""## Run Inference"""
def talk(utterance):
    #sentence = 'Bill got in the habit of asking hime
    
    align, spec, stop_tokens, wav = tts(model, utterance, TTS_CONFIG, use_cuda, ap, use_gl=False, figures=True)
    import wave
    wav_file = wave.open('utterance.wav','wb')           
    wav_file.setnchannels(1)
    wav_file.setsampwidth(2)
    wav_file.setframerate(22050.0)
    wav_file.writeframesraw(wav)
    wav_file.close()
if __name__ == "__main__":
   talk("Bill got in the habit of asking himself “Is that thought true?” and if he wasn’t absolutely certain it was, he just let it go.")